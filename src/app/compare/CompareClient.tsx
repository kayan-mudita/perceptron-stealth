          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-4 gap-3 mb-2">
              ...
              <div className="p-5 rounded-t-2xl border border-white/[0.04] border-b-0 bg-white/[0.015] text-center">
                ...
                <h3 className="text-p2 font-semibold text-white/60">
                  Do it yourself
                </h3>
              </div>
              {/* Agency */}
            ...
            <div className="grid grid-cols-4 gap-3 mt-4">
              ...
              <div className="text-center">
                <Link
                  href="/auth/signup"
                  className="btn-cta-glow inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg bg-white text-[#050508] text-p3 font-semibold hover:bg-white/90 active:bg-white/80 transition-all"
                >
                  Start free trial
            ...
            <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-4 md:hidden">
              {[
                ...
                >
                  <h3
                    className={`text-p2 font-semibold mb-3 ${
                      card.highlight ? "text-white/90" : "text-white/60"
                    }`}
                  >
                    {card.title}
                  </h3>
                  <div className="space-y-2 text-p3">
                  ...
                  {card.highlight && (
                    <Link
                      href="/auth/signup"
                      className="mt-4 block text-center text-p3 font-medium py-2.5 rounded-lg bg-white text-[#050508] hover:bg-white/90 transition-all"
                    >
                      Start free trial
                    </Link>
                  )}
